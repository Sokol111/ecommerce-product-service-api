...
func NewCreateProductRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/product/create")
	if operationPath[0] == '/' {
...
func NewGetProductByIdRequest(server string, id string) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/product/get/%s", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewGetListRequest(server string, params *GetListParams) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/product/list")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
func NewUpdateProductRequestWithBody(server string, contentType string, body io.Reader) (*http.Request, error) {
	...
	operationPath := fmt.Sprintf("/product/update")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
